...
export default async function SetupPage({ params }: { params: { guildId: string } }) {
  const readiness = getSetupReadiness();
  const zoro = await getBotConfig(params.guildId, 'zoro');
    ...
    <div className="pb-4">
      ...
      <Panel>
        ...
        <div className="flex flex-wrap gap-2 border-t border-ink/5 px-6 py-4">
          <Link
            href={`/dashboard/${params.guildId}/security`}
